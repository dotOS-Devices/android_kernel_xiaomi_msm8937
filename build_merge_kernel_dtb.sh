...
./../mkbootimg/mkbootimg --kernel arch/arm64/boot/kernel.img-dtb --ramdisk arch/arm64/boot/boot.img-ramdisk.cpio.gz --cmdline 'sched_enable_hmp=1 androidboot.hardware=qcom msm_rtb.filter=0x237 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 androidboot.bootdevice=7824900.sdhci earlycon=msm_hsl_uart,0x78af000 androidboot.selinux=permissive buildvariant=userdebug androidboot.emmc=true androidboot.verifiedbootstate=orange androidboot.veritymode=enforcing androidboot.keymaster=1 androidboot.serialno=4d44ca9e7cf4 device_locked=0 androidboot.baseband=msm mdss_mdp.panel=1:dsi:0:qcom:mdss_dsi_ili9881c_ebbg_720p_video:1:none:cfg:single_dsi board_id=S88536BA2:board_vol:=481964' --pagesize 2048 --base 0x80000000 --ramdiskaddr 0x81000000 -o arch/arm64/boot/boot.img
